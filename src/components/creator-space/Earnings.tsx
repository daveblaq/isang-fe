  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white p-2">
        <div className="mt-6 grid grid-cols-4 gap-4 text-xs font-ibm font-medium text-gray-700 bg-gray-50 p-5 border-b border-gray-200">
        ...
        <div className=" divide-y divide-gray-200">
          {guides.map((guide) => (
            <div
              key={guide}
              className="grid grid-cols-4 gap-4 px-2 py-6 text-sm hover:border-slate-100 hover:bg-slate-50"
            >
              <Text
                variant="span"
              ...
              <Text variant="span" className="text-sm text-slate-500">
                Technical difficulties on the theme
              </Text>
              <Text variant="span" className="text-sm text-slate-500">
                60 mins
              </Text>
