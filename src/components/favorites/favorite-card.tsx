  ...
  return (
    <div className="w-full md:flex-shrink-0 md:w-[320px] space-y-2 md:space-y-3">
      ...
      >
        ...
        <button
          className="absolute right-3 top-3 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white shadow-md hover:bg-white/90 transition-colors"
          onClick={(e) => {
            e.stopPropagation();
            setIsLiked(!isLiked);
          }}
      ...
      <div className="space-y-2">
        <Text
          variant="span"
          className="text-dm font-medium font-ibm text-slate-900"
        >
          {title}
        </Text>
